...
- `project_page/assets/case_a_photo_mri_visual_comparison.jpg`
- generated by `scripts/photo_mri_avatar/make_case_a_visual_mri_comparison.py`

It shows the same primary-subject photos, 3DDFA and MediaPipe baseline
overlays, and an automatic MRI face-cap proxy projected onto the photos.
Interpret this as visual QC for the alignment scaffold, not as
camera-calibrated anatomical registration.
