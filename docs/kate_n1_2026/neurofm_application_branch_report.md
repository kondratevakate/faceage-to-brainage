...
3. Even after weights are available, Kate/SIMON ages below 40 would be outside NeuroFM's documented age range, so results must be treated as application/QC output until calibrated against labeled data.
