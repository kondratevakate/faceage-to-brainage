...
def visualise_mesh_and_landmarks(mesh_name, blocking=True, window=None, renderer=None, sphere_size=1.25, off_screen=False, out_file=None):
    ...
    #ren.GetActiveCamera().SetFocalPoint(0, 0, -100)
