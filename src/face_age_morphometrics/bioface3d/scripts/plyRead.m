...
%% PLY READ----------------------------------------------------------------
% Función para la lectura de mallas (vertices y caras)
%
% Parámetros de entrada:
%       - filename : Path del archivo .ply
%       - face_index_start: Número del primer vertice del .ply
%       (generalmente 1)
%
% Parámetros de salida:
%       - vertices: Puntos de la malla
%       - faces : Caras de la malla
%
% NOTA: Basado en el código de MATLAB Exchange
%
% Heredia Lidon, Alvaro - La Salle URL, 2021
%--------------------------------------------------------------------------
