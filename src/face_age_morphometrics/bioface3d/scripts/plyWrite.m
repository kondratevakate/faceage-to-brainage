...
%% PLY WRITE---------------------------------------------------------------
% Función para la escritura de mallas (vertices y caras)
%
% Parámetros de entrada:
%       - xyz : Matriz (nx3) de vertices de la malla
%       - face : Matriz (nx3) de caras de la malla
%       - filename : Path del archivo .ply de salida
%
